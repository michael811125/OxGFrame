...
namespace OxGFrame.CoreFrame.Editor
{
    ...
    /// </summary>
    [Serializable]
    public class AttrGenericDictionary<TKey, TValue> : IDictionary<TKey, TValue>, ISerializationCallbackReceiver
    {
        // Internal
        [SerializeField]
...
#pragma warning restore 0414
        ...
        {
            public TKey AttrName;
            public TValue AttrReference;
            public KeyValuePair(TKey Key, TValue Value)
            {
                this.AttrName = Key;
                this.AttrReference = Value;
            }
        }
        ...
        public void OnAfterDeserialize()
        {
            ...
            for (int i = 0; i < list.Count; i++)
            {
                ...
                {
                    dict.Add(key, list[i].AttrReference);
        ...
        public void Sort()
        {
            this.list = this.list.OrderBy(o => o.AttrName).ToList();
        }
