...
namespace OxGFrame.CoreFrame.Editor
{
    ...
    /// </summary>
    [Serializable]
    public class VariableGenericDictionary<TKey, TValue> : IDictionary<TKey, TValue>, ISerializationCallbackReceiver
    {
        // Internal
        [SerializeField]
...
#pragma warning restore 0414
        ...
        {
            public TKey VariableAccessModifier;
            public TValue VariablePrefix;
        ...
        public void OnAfterDeserialize()
        {
            ...
            {
                var key = list[i].VariableAccessModifier;
                if (key != null && !ContainsKey(key))
                {
                    dict.Add(key, list[i].VariablePrefix);
        ...
        public void Sort()
        {
            this.list = this.list.OrderBy(o => o.VariableAccessModifier).ToList();
        }
