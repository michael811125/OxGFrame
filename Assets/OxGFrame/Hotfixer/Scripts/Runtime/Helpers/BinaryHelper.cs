    ...
    public static class BinaryHelper
    {
        ...
        public static ConfigInfo DecryptToString(byte[] data)
        {
            ...
            if (header == HotfixSettings.CIPHER_HEADER)
            {
                ...
                Debug.Log($"[Source is Cipher] Check -> {HotfixSettings.settings.hotfixCfgName}{HotfixSettings.settings.hotfixCfgExtension}");
            }
            else
            {
                ...
                Debug.Log($"[Source is Plaintext] Check -> {HotfixSettings.settings.hotfixCfgName}{HotfixSettings.settings.hotfixCfgExtension}");
            }
