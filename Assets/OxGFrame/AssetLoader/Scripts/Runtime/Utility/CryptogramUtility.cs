...
namespace OxGFrame.AssetLoader.Utility
{
    public static class CryptogramUtility
    {
        ...
        internal static class CryptogramSettingsSetup
        {
            private static CryptogramSettings _settings;

            public static CryptogramSettings GetSettings()
            {
                if (_settings == null)
                    _settings = AssetUtility.LoadSettingsData<CryptogramSettings>();
                return _settings;
            }
        }
