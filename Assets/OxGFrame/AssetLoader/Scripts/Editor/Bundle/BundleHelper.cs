...
public static class BundleHelper
{
    ...
    /// <summary>
    /// 輸出 App 配置檔至輸出路徑 (for Built-in [StreamingAssets])
    /// </summary>
    /// <param name="productName"></param>
    /// <param name="inputPath"></param>
    /// <param name="outputPath"></param>
    /// <param name="compressed"></param>
    internal static void ExportAppConfig(string productName, string appVersion, string outputPath, bool activeBuildTarget, BuildTarget buildTarget)
    {
    ...
    /// <summary>
    /// 產生 Bundle URL 配置檔至輸出路徑 (for Built-in [StreamingAssets])
    /// </summary>
    /// <param name="productName"></param>
    /// <param name="appVersion"></param>
    /// <param name="outputPath"></param>
