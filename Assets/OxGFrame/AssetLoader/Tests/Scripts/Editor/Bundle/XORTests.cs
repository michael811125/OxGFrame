...
namespace OxGFrame.AssetLoader.Editor.Tests
{
    public class XORTests
    {
        ...
        public void EncryptDecryptBytesFromData()
        {
            ...
            stopwatch.Stop();
            UnityEngine.Debug.Log($"[EncryptDecryptBytesFromData] XOR.EncryptBytes execution time: {stopwatch.Elapsed.TotalMilliseconds} ms, DataSize: {BundleUtility.GetBytesToString(dataSize)}");
            ...
            stopwatch.Stop();
            UnityEngine.Debug.Log($"[EncryptDecryptBytesFromData] XOR.DecryptBytes execution time: {stopwatch.Elapsed.TotalMilliseconds} ms, DataSize: {BundleUtility.GetBytesToString(dataSize)}");
        ...
        public void EncryptDecryptWriteFile()
        {
            ...
            stopwatch.Stop();
            UnityEngine.Debug.Log($"[EncryptDecryptWriteFile] XOR.WriteFile.EncryptFile execution time: {stopwatch.Elapsed.TotalMilliseconds} ms, DataSize: {BundleUtility.GetBytesToString(dataSize)}");
            ...
            stopwatch.Stop();
            UnityEngine.Debug.Log($"[EncryptDecryptWriteFile] XOR.WriteFile.DecryptFile execution time: {stopwatch.Elapsed.TotalMilliseconds} ms, DataSize: {BundleUtility.GetBytesToString(dataSize)}");
        ...
        public void EncryptDecryptBytesFromFile()
        {
            ...
            stopwatch.Stop();
            UnityEngine.Debug.Log($"[EncryptDecryptBytesFromFile] XOR.EncryptBytes execution time: {stopwatch.Elapsed.TotalMilliseconds} ms, DataSize: {BundleUtility.GetBytesToString(dataSize)}");
            ...
            stopwatch.Stop();
            UnityEngine.Debug.Log($"[EncryptDecryptBytesFromFile] XOR.DecryptBytes execution time: {stopwatch.Elapsed.TotalMilliseconds} ms, DataSize: {BundleUtility.GetBytesToString(dataSize)}");
        ...
        public void DecryptStream()
        {
            ...
            UnityEngine.Debug.Log($"[DecryptStream] XOR.DecryptStream execution time: {stopwatch.Elapsed.TotalMilliseconds} ms, DataSize: {BundleUtility.GetBytesToString(dataSize)}");
