...
namespace OxGFrame.AssetLoader.Editor.Tests
{
    public class XXTEATests
    {
        ...
        public void EncryptDecryptBytesFromData()
        {
            ...
            stopwatch.Stop();
            UnityEngine.Debug.Log($"[EncryptDecryptBytesFromData] XXTEA.EncryptBytes execution time: {stopwatch.Elapsed.TotalMilliseconds} ms, DataSize: {BundleUtility.GetBytesToString(dataSize)}");
            ...
            stopwatch.Stop();
            UnityEngine.Debug.Log($"[EncryptDecryptBytesFromData] XXTEA.DecryptBytes execution time: {stopwatch.Elapsed.TotalMilliseconds} ms, DataSize: {BundleUtility.GetBytesToString(dataSize)}");
        ...
        public void EncryptDecryptWriteFile()
        {
            ...
            stopwatch.Stop();
            UnityEngine.Debug.Log($"[EncryptDecryptWriteFile] XXTEA.WriteFile.EncryptFile execution time: {stopwatch.Elapsed.TotalMilliseconds} ms, DataSize: {BundleUtility.GetBytesToString(dataSize)}");
            ...
            stopwatch.Stop();
            UnityEngine.Debug.Log($"[EncryptDecryptWriteFile] XXTEA.WriteFile.DecryptFile execution time: {stopwatch.Elapsed.TotalMilliseconds} ms, DataSize: {BundleUtility.GetBytesToString(dataSize)}");
        ...
        public void EncryptDecryptBytesFromFile()
        {
            ...
            stopwatch.Stop();
            UnityEngine.Debug.Log($"[EncryptDecryptBytesFromFile] XXTEA.EncryptBytes execution time: {stopwatch.Elapsed.TotalMilliseconds} ms, DataSize: {BundleUtility.GetBytesToString(dataSize)}");
            ...
            stopwatch.Stop();
            UnityEngine.Debug.Log($"[EncryptDecryptBytesFromFile] XXTEA.DecryptBytes execution time: {stopwatch.Elapsed.TotalMilliseconds} ms, DataSize: {BundleUtility.GetBytesToString(dataSize)}");
        ...
        public void DecryptStream()
        {
            ...
            UnityEngine.Debug.Log($"[DecryptStream] XXTEA.DecryptStream execution time: {stopwatch.Elapsed.TotalMilliseconds} ms, DataSize: {BundleUtility.GetBytesToString(dataSize)}");
