...
namespace OxGFrame.AssetLoader.Editor.Tests
{
    public class AESTests
    {
        ...
        public void EncryptDecryptBytesFromData()
        {
            ...
            stopwatch.Stop();
            UnityEngine.Debug.Log($"[EncryptDecryptBytesFromData] AES.EncryptBytes execution time: {stopwatch.Elapsed.TotalMilliseconds} ms, DataSize.DATA_SIZE: {BundleUtility.GetBytesToString(CryptogramConfig.DATA_SIZE)}");
            ...
            stopwatch.Stop();
            UnityEngine.Debug.Log($"[EncryptDecryptBytesFromData] AES.DecryptBytes execution time: {stopwatch.Elapsed.TotalMilliseconds} ms, DataSize.DATA_SIZE: {BundleUtility.GetBytesToString(CryptogramConfig.DATA_SIZE)}");
        ...
        public void EncryptDecryptWriteFile()
        {
            ...
            stopwatch.Stop();
            UnityEngine.Debug.Log($"[EncryptDecryptWriteFile] AES.WriteFile.EncryptFile execution time: {stopwatch.Elapsed.TotalMilliseconds} ms, DataSize.DATA_SIZE: {BundleUtility.GetBytesToString(CryptogramConfig.DATA_SIZE)}");
            ...
            stopwatch.Stop();
            UnityEngine.Debug.Log($"[EncryptDecryptWriteFile] AES.WriteFile.DecryptFile execution time: {stopwatch.Elapsed.TotalMilliseconds} ms, DataSize.DATA_SIZE: {BundleUtility.GetBytesToString(CryptogramConfig.DATA_SIZE)}");
        ...
        public void EncryptDecryptBytesFromFile()
        {
            ...
            stopwatch.Stop();
            UnityEngine.Debug.Log($"[EncryptDecryptBytesFromFile] AES.EncryptBytes execution time: {stopwatch.Elapsed.TotalMilliseconds} ms, DataSize.DATA_SIZE: {BundleUtility.GetBytesToString(CryptogramConfig.DATA_SIZE)}");
            ...
            stopwatch.Stop();
            UnityEngine.Debug.Log($"[EncryptDecryptBytesFromFile] AES.DecryptBytes execution time: {stopwatch.Elapsed.TotalMilliseconds} ms, DataSize.DATA_SIZE: {BundleUtility.GetBytesToString(CryptogramConfig.DATA_SIZE)}");
        ...
        public void DecryptStream()
        {
            ...
            UnityEngine.Debug.Log($"[DecryptStream] AES.DecryptStream execution time: {stopwatch.Elapsed.TotalMilliseconds} ms, DataSize.DATA_SIZE: {BundleUtility.GetBytesToString(CryptogramConfig.DATA_SIZE)}");
